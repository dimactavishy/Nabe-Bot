...
module.exports = {
    info: {
        name: "hyuri",
        description: `Sends a lewd image of two [Yuri](https://en.wikipedia.org/wiki/Yuri_(genre)) girls.`,
        usage: "",
        cooldown: 10,
    },
    async execute(client, message, args, Discord) {
        ...
        neko.nsfw.yuri().then(yuri => {
            const embed_nsfw = new Discord.MessageEmbed()
                .setTitle('P-Pervert!')
                .setColor('#FFC0CB')
                .setDescription(`(>///<)`)
                .addField(`Provided by Nekos.life`, `[Full-Res Image](${yuri.url})`)
