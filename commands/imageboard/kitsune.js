...
module.exports = {
    info: {
        name: "kitsune",
        description: `Sends a picture of a Fox-eared girl.`,
        usage: "",
        cooldown: 10,
    },
    async execute(client, message, args, Discord) {
        ...
        neko.sfw.foxGirl().then(foxGirl => {
            const embed_sfw = new Discord.MessageEmbed()
                ...
                .setColor('GREEN')
                .setDescription(`I want to hug the fox's tail, they seem fluffy...`)
                .addField(`Provided by Nekos.life`, `[Full-Res Image](${foxGirl.url})`)
